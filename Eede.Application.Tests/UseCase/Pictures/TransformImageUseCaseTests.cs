...
public class TransformImageUseCaseTests
{
    ...
    public void SetUp()
    {
        // 4x1 pixels: Red, Green, Blue, Yellow
        byte[] data = new byte[] {
            255, 0, 0, 255, // Red (0,0)
            0, 255, 0, 255, // Green (1,0)
            0, 0, 255, 255, // Blue (2,0)
            255, 255, 0, 255 // Yellow (3,0)
        };
    ...
    public void Execute_NoSelection_MirrorCopyRight_MirrorsEntireCanvas()
    {
        ...
        AssertColor(result, 1, 0, 0, 255, 0, 255);
        AssertColor(result, 2, 0, 0, 255, 0, 255);
        AssertColor(result, 3, 0, 255, 0, 0, 255);
    }
    ...
    {
        // Arrange
        // 1x4 pixels: Red, Green, Blue, Yellow (vertical)
        byte[] data = new byte[] {
            255, 0, 0, 255, // y=0
            0, 255, 0, 255, // y=1
            0, 0, 255, 255, // y=2
        ...
        AssertColor(result, 0, 0, 255, 0, 0, 255);
        AssertColor(result, 0, 1, 0, 255, 0, 255);
        AssertColor(result, 0, 2, 0, 255, 0, 255);
        AssertColor(result, 0, 3, 255, 0, 0, 255);
    }
