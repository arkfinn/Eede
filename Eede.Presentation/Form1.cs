...
namespace Eede
{
    internal partial class Form1 : Form, IViewFor<Form1ViewModel>
    {
        ...
        private void AddChildWindow(PictureFile file)
        {
            ...
            form.PicturePulled += new EventHandler<PicturePushEventArgs>(ChildFormPicturePulled);
            form.PicturePushed += new EventHandler<PicturePullEventArgs>(ChildFormPicturePushed);
            form.Show();
            toolStripButton_saveFile.Enabled = true;

            // TODO:
            ViewModel.Pictures.Add(DockPictureViewModel.FromUri(new Uri(file.FilePath.Path)));
        }
        ...
        private void ChildFormPicturePulled(object sender, PicturePushEventArgs e)
        {
        ...
        private void ChildFormPicturePushed(object sender, PicturePullEventArgs e)
        {
