...
public class SelectionClipboardTests
{
    ...
    private SelectionClipboard _SelectionClipboard;
    ...
    public async Task CopyAsync_DelegatesToCopyUseCase()
    {
        ...
        await _SelectionClipboard.CopyAsync(picture, area);
    ...
    public async Task CutAsync_DelegatesToCutUseCase()
    {
        ...
        var result = await _SelectionClipboard.CutAsync(picture, area);
