...
{
    [TestFixture]
    public class RgbAntiAliasStrategyTests
    {
        private RgbAntiAliasStrategy _strategy;

        [SetUp]
        public void Setup()
        {
            _strategy = new RgbAntiAliasStrategy();
        }
        ...
        {
            byte[] p1 = new byte[] { 0, 0, 0, 255 }; // Black
            byte[] p2 = new byte[] { 10, 10, 10, 255 }; // Dark Gray
        ...
        [Test]
        public unsafe void Blend_BlendsRgbAndDoesNotTouchAlpha()
        {
            byte[] src = new byte[] { 255, 255, 255, 255 }; // White
            byte[] dst = new byte[] { 0, 0, 0, 128 }; // Black with 128 Alpha
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(dst[3], Is.EqualTo(128), "Alpha channel should not be touched");
            });
        }
        ...
        {
            byte[] src = new byte[] { 255, 255, 255, 255 }; // White
            byte[] dst = new byte[] { 0, 0, 0, 255 }; // Black
        ...
        {
            byte[] src = new byte[] { 255, 255, 255, 255 }; // White
            byte[] dst = new byte[] { 100, 100, 100, 255 }; // Gray
